...
//MARK: - SpawnArrowEnemy
    func spawnArrowEnemy() {
            ...
            portal.name = "Portal"
        portal.setScale(0.6)
            portal.position = CGPoint(x: 5480, y: -80)
            portal.zPosition = 29
    ...
    func spawnArrowEnemy2() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 1440, y: -80)
            portal.zPosition = 29
...
//MARK: - PortalEndBall
    ...
    func spawnTrapBall2() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 12920, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal2() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 12920, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall3() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 7040, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal3() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 7040, y: 170)
            portal.zPosition = 29
            addChild(portal)
