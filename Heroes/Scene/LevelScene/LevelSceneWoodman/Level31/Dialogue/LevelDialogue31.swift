...
//MARK: - CloseButton
    ...
    //MARK: - Preview
        func spawnDialogue() {
            ...
            label.text = NSLocalizedString("Пора заканчивать на сегодня, солнце уже садится.", comment: "31")
        ...
        func spawnDialogue2() {
            ...
            label2.position = CGPoint(x: 0, y: positionY)
        ...
        func spawnDialogue5() {
            ...
            label5.preferredMaxLayoutWidth = sizeX
            label5.position = CGPoint(x: 0, y: positionY)
