...
//MARK: - SpawnActionGroundEndActionTrap
    ...
    func actionTrap1() {
        ...
        let actionMoveBack = SKAction.moveTo(y: -180, duration: 0.9)
...
//MARK: - SpawnArrowEnemy
    func spawnArrowEnemy2() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 3580, y: -60)
            portal.zPosition = 29
...
//MARK: - PortalEndBall
    ...
    func spawnTrapBall2() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 10570, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnTrapBall3() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 10830, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnTrapBall5() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 14350, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal5() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 14350, y: 170)
            portal.zPosition = 29
            addChild(portal)
