...
//MARK: - PortalEndBall
    func spawnTrapBall1() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 7120, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal1() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 7120, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall2() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 11880, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal2() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 11880, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall3() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 12590, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal3() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 12590, y: 170)
            portal.zPosition = 29
            addChild(portal)
