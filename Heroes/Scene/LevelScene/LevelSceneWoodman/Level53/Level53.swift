...
//MARK: - SpawnArrowEnemy
    func spawnArrowEnemy2() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 9200, y: 10)
            portal.zPosition = 29
    ...
    func spawnArrowEnemy3() {
        ...
        portal.name = "Portal"
        portal.setScale(0.6)
        portal.position = CGPoint(x: 9730, y: -90)
        portal.zPosition = 29
        portal.zRotation = 1.5
        addChild(portal)
    ...
    func spawnArrowEnemy4() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 15510, y: -90)
            portal.zPosition = 29
            portal.zRotation = 1.5
            addChild(portal)
...
//MARK: - PortalEndBall
    func spawnTrapBall1() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 2880, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal1() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 2880, y: 170)
            portal.zPosition = 29
            addChild(portal)
