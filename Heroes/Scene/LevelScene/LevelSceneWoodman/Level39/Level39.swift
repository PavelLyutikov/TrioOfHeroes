...
//MARK: - SpawnArrowEnemy
    func spawnArrowEnemy() {
            ...
            portal.name = "Portal"
        portal.setScale(0.6)
            portal.position = CGPoint(x: 3330, y: -70)
            portal.zPosition = 29
    ...
    func spawnArrowEnemy2() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 950, y: -90)
            portal.zPosition = 29
    ...
    func spawnArrowEnemy3() {
            ...
            portal.name = "Portal"
        portal.setScale(0.6)
            portal.position = CGPoint(x: 10020, y: -70)
            portal.zPosition = 29
            portal.zRotation = 4.7
            addChild(portal)
    ...
    func spawnArrowEnemy4() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 10800, y: -90)
            portal.zPosition = 29
            portal.zRotation = 1.5
            addChild(portal)
    ...
    func spawnArrowEnemy5() {
            ...
            portal.name = "Portal"
        portal.setScale(0.6)
            portal.position = CGPoint(x: 15720, y: -100)
            portal.zPosition = 29
            portal.zRotation = 4.7
            addChild(portal)
...
//MARK: - PortalEndBall
    func spawnTrapBall1() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 2210, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal1() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 2210, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall2() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 5220, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnTrapBall3() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 14100, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal3() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 14100, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall4() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 14980, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal4() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 14980, y: 170)
            portal.zPosition = 29
            addChild(portal)
