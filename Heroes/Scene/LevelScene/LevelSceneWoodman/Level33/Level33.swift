...
//            arrow.zRotation = 3.12
            ...
            portal.name = "Portal"
        portal.setScale(0.6)
            portal.position = CGPoint(x: 1945, y: -90)
    ...
    func spawnArrowEnemy2() {
        ...
        let impulse = SKAction.applyImpulse(action, duration: 1.4)
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 4150, y: -10)
            portal.zPosition = 29
...
//MARK: - PortalEndBall
    func spawnTrapBall() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 9110, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 9110, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall2() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 10360, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnTrapBall3() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 11520, y: 150)
            stone.zPosition = 30
            addChild(stone)
