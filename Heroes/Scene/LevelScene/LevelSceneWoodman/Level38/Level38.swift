...
func spawnStone() {
        ...
        stone.name = "Stone"
        stone.setScale(0.6)
        stone.position = CGPoint(x: 2960, y: 320)
        stone.zPosition = 30
        addChild(stone)
...
//MARK: - SpawnArrowEnemy
    func spawnArrowEnemy() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 8400, y: -100)
            portal.zPosition = 29
    ...
    func spawnArrowEnemy2() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 3030, y: -40)
            portal.zPosition = 29
...
//MARK: - PortalEndBall
    func spawnTrapBall1() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 890, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal1() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 890, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall2() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 3790, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal2() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 3790, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall3() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 11060, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal3() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 11060, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall4() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 15190, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal4() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 15190, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall6() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 15490, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal6() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 15490, y: 170)
            portal.zPosition = 29
            addChild(portal)
