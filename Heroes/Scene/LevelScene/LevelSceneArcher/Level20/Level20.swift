...
//MARK: - SpawnArrowEnemy
    func spawnArrowEnemy() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 3840, y: -90)
...
//MARK: - PortalEndBall
    func spawnTrapBall() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 5680, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 5680, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall2() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 10700, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal2() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 10700, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall4() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 6480, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal4() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 6480, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall6() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 7760, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal6() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 7760, y: 170)
            portal.zPosition = 29
            addChild(portal)
