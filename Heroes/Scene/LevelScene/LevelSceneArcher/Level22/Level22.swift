...
class Level22: GameScene {
    ...
    override func didMove(to view: SKView) {
        ...
        run(SKAction.repeatForever(SKAction.sequence([SKAction.run(){ [weak self] in
            self!.spawnTrapBall5()
            self!.spawnPortal5()
        }, SKAction.wait(forDuration: 18.8)])))
...
//MARK: - SpawnArrowEnemy
    func spawnArrowEnemy() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 6100, y: -40)
            portal.zPosition = 29
...
//MARK: - PortalEndBall
    func spawnTrapBall() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 3220, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 3220, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall2() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 3420, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal2() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 3420, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall3() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 5160, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal3() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 5160, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall5() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 8000, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal5() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 8000, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall7() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 9200, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal7() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 9200, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall8() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 10760, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal8() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 10760, y: 170)
            portal.zPosition = 29
            addChild(portal)
