...
//            arrow.zRotation = 3.12
            ...
            portal.name = "Portal"
        portal.setScale(0.6)
            portal.position = CGPoint(x: 5940, y: -30)
    ...
    func spawnArrowEnemy2() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 7485, y: -100)
            portal.zPosition = 1.5
...
//MARK: - SpawnPortalEndBall
    func spawnTrapBall() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 1030, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 1030, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall3() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 9510, y: 150)
            stone.zPosition = 30
            addChild(stone)
