...
class LevelDialogue18: SKScene {

    var close: SKButton!
    let dial = SKSpriteNode(imageNamed: "dialogue18")
...
//MARK: - Preview
    func spawnDialogue() {
        ...
        label.text = NSLocalizedString("У костяшек просто нет шансов, только нужно немного поднажать, дружище!", comment: "18")
