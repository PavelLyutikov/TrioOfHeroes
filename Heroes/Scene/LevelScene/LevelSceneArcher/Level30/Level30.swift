...
//MARK: - PortalEndBall
    func spawnTrapBall() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 320, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 320, y: 170)
            portal.zPosition = 29
            addChild(portal)
    ...
    func spawnTrapBall6() {
            ...
            stone.name = "Ball"
            stone.setScale(0.6)
            stone.position = CGPoint(x: 11120, y: 150)
            stone.zPosition = 30
            addChild(stone)
    ...
    func spawnPortal6() {
            ...
            portal.name = "Portal"
            portal.setScale(0.6)
            portal.position = CGPoint(x: 11120, y: 170)
            portal.zPosition = 29
            addChild(portal)
